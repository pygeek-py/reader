    ...
    <div>
        <div className='bod1'>
            ...
            <div className='secpage'>
                <button className='sec6' onClick={one}><FaAngleDoubleLeft /></button>
                <button className='sec6' onClick={one}>1</button>
                <button className='sec6i'>2</button>
                <button className='sec6' onClick={thr}>3</button>
                <button className='sec6' onClick={thr}><FaAngleDoubleRight /></button>
            </div>
        </div>
    </div>
  )
